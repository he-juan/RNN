...
function getMicrophoneAccess() {
    console.warn("getMicrophoneAccess  getMicrophoneAccess")
    if (microphoneIsWiredUp) {
        console.warn("return:")
        return;
    }
...
function liveNoiseSuppression(type, item) {
    console.warn("liveNoiseSuppression_type:", type)
    console.warn("liveNoiseSuppression_item:",item)
    if (selectedLiveNoiseSuppression)
        selectedLiveNoiseSuppression.classList.remove("selected");
...
function liveNoise(type, item) {
    ...
    addNoise = !!type;
    if (selectedLiveNoise)
        selectedLiveNoise.classList.remove("selected");
